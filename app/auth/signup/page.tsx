  ...
  return (
    <div className="relative w-full max-w-md">
      ...
      <div className="rounded-2xl border border-[rgba(255,255,255,0.08)] bg-[rgba(255,255,255,0.03)] p-8">
        ...
        >
          {loading ? (
            ...
            <svg className="w-5 h-5" viewBox="0 0 24 24">
              ...
              <path fill="#FBBC05" d="M5.27698177,14.2678769 C5.03832634,13.556323 4.90909091,12.7937589 4.90909091,12 C4.90909091,11.2182781 5.03443647,10.4668121 5.26629829,9.76452941 L1.23999023,6.65002441 C0.43658717,8.26043162 0,10.0753848 0,12 C0,13.9195484 0.444780743,15.7 41 L5.27698177,14.2678769 Z"/>
            </svg>
          )}
        ...
        <Link
          href={`/auth/login?plan=${planKey}`}
          className="block w-full text-center py-3 text-sm font-medium text-[rgba(255,255,255,0.45)] hover:text-white transition-colors"
        >
