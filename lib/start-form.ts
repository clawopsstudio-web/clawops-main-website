...
export const PLANS = [
  {
    ...
    name: 'Personal',
    price: 49,
    description: 'Your first AI team. Everything included.',
    features: ['2 AI agents', '20,000 tool calls/mo', 'All messaging platforms', 'Email support (48hr SLA)'],
  },
  {
    id: 'team',
    name: 'Team',
    price: 149,
    description: 'Your full AI department.',
    features: ['5 AI agents', '200,000 tool calls/mo', 'All platforms + analytics', 'Priority support (12hr SLA)'],
  },
  {
    id: 'business',
    name: 'Business',
    ...
    features: ['10 AI agents', '1M tool calls/mo', 'White-label + API access', 'Dedicated support (4hr SLA)'],
  },
  {
    id: 'enterprise',
    name: 'Enterprise',
    price: 349,
    description: 'Built for serious teams.',
    features: ['20 AI agents', '1M tool calls/mo', 'Custom SLA + on-premise', 'Dedicated account manager'],
  },
]
