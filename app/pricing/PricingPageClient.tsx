...
const COMPARISON = [
  ...
  { feature: "AI Inference", starter: "Cloud", pro: "Cloud +", business: "Cloud + Custom" },
...
const FAQS = [
  ...
  },
  {
    ...
    a: "All plans include access to Claude Opus 4.6, GPT-4.4, and MiniMax 2.5 via API. Cloud inference is included in every plan — no local setup required.",
  },
  {
